...
(comment
  ...
  (def line-data-file "/home/jansenh/data/netex/KOL/KOL_KOL-Line-8_5986_1025_Fogn---Judaberg---Helgoy.xml")
...
(comment ;; --------------------------------------------------------------------
  ...
  ;; 1. Load shared data
  (reg/load-file! "/home/jansenh/data/netex/KOL/_KOL_shared_data.xml")
  (reg/stats)

  ;; 2. Parse line file
  (def data (line/parse-line-file "/home/jansenh/data/netex/KOL/KOL_KOL-Line-8_5986_1025_Fogn---Judaberg---Helgoy.xml"))
...
(comment ;; --------------------------------------------------------------------
  ...
  (def shared-data (exp/explore-line-file "/home/jansenh/data/netex/KOL/_KOL_shared_data.xml"))
  ;; Load line file

  (def data (exp/explore-line-file "/home/jansenh/data/netex/KOL/KOL_KOL-Line-8_5986_1025_Fogn---Judaberg---Helgoy.xml"))

;; Debug
  (def pub-del (parser/parse-xml-file "/home/jansenh/data/netex/KOL/KOL_KOL-Line-8_5986_1025_Fogn---Judaberg---Helgoy.xml"))
...
;; Basic stats
  (:journey-count data)     ;; => ~100+ journeys
  (:interchange-count data) ;; => number of interchanges
  (:stay-seated-count data) ;; => how many are stay-seated
...
;; ---------------------------------------------------------------------------
  ...
  (:journey-count data)        ;; => 143
  (:interchange-count data)    ;; => 81
  (:stay-seated-count data)    ;; => ?
  (count (:graph data))        ;; => ? (number of journeys with outbound connections)
...
;; ===========================================================================
  ...
  (:journeys data)      ;; map: id -> {:name, :day-type-refs, :passing-times [...]}
  (:interchanges data)  ;; seq: [{:from-journey, :to-journey, :stay-seated, ...}]
  (:graph data)         ;; map: from-journey-id -> [to-journey-ids] (StaySeated only)

;; ===========================================================================
  ;; ServiceJourneyInterchange
  ;;
  ;; Load shared data and line data
...
(comment
  ...
  (reg/load-file! "/home/jansenh/data/netex/KOL/_KOL_shared_data.xml")
  (reg/load-line-file! "/home/jansenh/data/netex/KOL/KOL_KOL-Line-8_5986_1025_Fogn---Judaberg---Helgoy.xml")
...
(comment
  ...
  (let [pd (parser/parse-xml-file "/home/jansenh/data/netex/KOL/_KOL_shared_data.xml")
        ;; Find first Operator
